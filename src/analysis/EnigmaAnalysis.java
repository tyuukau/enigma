...
import analysis.fitness.Fitness;
import model.Enigma;
...
public class EnigmaAnalysis {
    ...
    public static ScoredEnigmaKey[] findRotorConfiguration(String ciphertext, AvailableRotors rotors, String plugboard, int requiredKeys, Fitness f) {
                    ...
                    for (int i = 0; i < 26; i++) {
                        for (int j = 0; j < 26; j++) {
                            for (int k = 0; k < 26; k++) {
                                ...
                                String output = e.encrypt(ciphertext);
                                char[] decryption = output.toCharArray();
    ...
    public static ScoredEnigmaKey findRingSettings(EnigmaKey key, String ciphertext, Fitness f) {
    ...
    public static int findRingSetting(EnigmaKey key, String ciphertext, int rotor, Fitness f) {
    ...
    public static String findPlug(EnigmaKey key, String ciphertext, Fitness f) {
    ...
    public static ScoredEnigmaKey findPlugs(EnigmaKey key, int maxPlugs, String ciphertext, Fitness f) {
        EnigmaKey currentKey = new EnigmaKey(key);
        String plugs = "";
