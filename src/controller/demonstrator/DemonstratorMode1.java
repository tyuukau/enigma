...
public class DemonstratorMode1 extends AbstractDemonstrator {

    HBox upperPane = new HBox();

    Pane insidePane = new Pane();
    GridPane charPane = new GridPane();

    TableView<SequenceData> table = new TableView<SequenceData>();
    ...
    public DemonstratorMode1(ArrayList<AbstractScheduler> selectedAlgorthims) {
        ...
        setTable(table, this.selectedAlgorthimsData.get(0).getSequenceData());
        setInsidePane(insidePane, charPane, 0);
        upperPane.getChildren().addAll(table, insidePane);
