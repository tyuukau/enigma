...
public class LOOKScheduler extends AbstractSchedulerWithDirection {

    public LOOKScheduler(int[] requests, int head, Boolean direction) {
        super("LOOK" + (direction ? "Right" : "Left"), requests, head, direction);
    }
